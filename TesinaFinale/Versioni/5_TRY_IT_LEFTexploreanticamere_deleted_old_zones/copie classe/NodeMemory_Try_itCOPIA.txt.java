...
public class NodeMemory_Try_it extends NodeVec2Array
	{
        ...
        public NodeMemory_Try_it(boolean memory_control, int t1, int t2, int t3, SimpleInterface ar) {
           ...
           abstract_robot = ar;
           attractorType1 = t1; //bandierina 1
           attractorType2 = t2; //bandierina 2
           attractorType3 = t3; //baniderina 3
           control = memory_control; //variabile boolean
            ...
            if(im0.length !=0)
            {
                ...
                for(int i=0; i<im1.length; i++)
                {
                    ...
                    { 
                        ...
                        //NON SERVE PI� PERCH� HO AGGIUNTO LA CONDIZIONE VEDI SE C'� LA BANDIERINA
                        /*else
