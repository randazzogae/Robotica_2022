...
def calc_input(time):
    if time <= 5.0:  # wait at first
        v = 0.0 #velocità lineare
        yaw_rate = 0.0 #velocità angolare
      #  if time > 5.0:
       #     v = 3.0
        #    yaw_rate = 1.0 # per modificare la traiettoria modificare velocità lineare e velocità angolare
    else:
        v = 1.0  # [m/s]
        yaw_rate = 0.1  # [rad/s]
...
def main():
    ...
    n_landmark = 15 #RFID.shape[0] #ritorna il numero delle righe della matrice RFID.
