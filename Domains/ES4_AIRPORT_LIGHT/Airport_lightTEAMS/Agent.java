...
public class Agent extends ControlSystemMFN150
	...
	public void configure(){
           ...
           plan.setPlan(client.invoke("do(catch_plane,s0,S)"),0);  
            ...
            STATE_MACHINE.triggers[0][0]  = plan.isFinished(abstract_robot.getTime()); //return true quando viene resettato, cioè quando finisce il piano
            STATE_MACHINE.follow_on[0][0] = 1; //non esiste, quindi esci
	...
	public int takeStep(){
            ...
            time++;
            if(time==490){
                PF_IS_LATE.setValue(false); //se false, fuma
