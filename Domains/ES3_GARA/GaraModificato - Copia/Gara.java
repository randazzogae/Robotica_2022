...
public class Gara extends ControlSystemMFN150Explore
    ...
    //======
        ...
        LASER_CONFIGURATION.embedded[4] = true;
	...
	public int takeStep() 
		...
		//SONAR
                ...
                if(bresult){
					...
					System.out.println("TIMER: " + (int) curr_time/15750);
					System.out.println("________________________________________________");
				}
		...
		//int state=STATE_MACHINE.Value(curr_time);
				...
				else if(state==5)
				{
					...
					if(letto==false)
					{	
					 System.out.println("TEMPO TOTALE IMPIEGATO " + (float) curr_time/15750);
					 letto=true;
					}
            try {
                Thread.sleep(10000);
				...
				if(curr_time % 15750 == 0)
				{
					if (letto==false)
					{
						System.out.println("Tempo trascorso: " + (float) curr_time/15750);
					}
				}
