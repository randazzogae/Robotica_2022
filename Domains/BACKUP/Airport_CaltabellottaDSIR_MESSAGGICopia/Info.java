...
public class Info extends ControlSystemMFN150 {
    ...
    private double noisegain = 0; // noise
    ...
    public void configure() {
        ...
        PS_HOMEBASE1_GLOBAL = new v_FixedPoint_(-17.03,-0.40);
    ...
    public int takeStep() {
        ...
        if(state==0)
            abstract_robot.setDisplayString("Info");
