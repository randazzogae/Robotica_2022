...
public class OccorrenzaSonar extends ControlSystemMFN150Explore
	{
	...
	private i_FSA_ba            STATE_MACHINE;
        ...
        private DynamicSonarStrategy sonar_strategy;	//istanzio una SonarStrategy
	...
	public void configure()
		...
		abstract_robot.setBaseSpeed(0.15*abstract_robot.MAX_TRANSLATION);
		...
		PS_OBS = new va_Obstacles_r(abstract_robot);
                ...
                /*NodeVec2Array
                PS_SONAR_EGO = new va_Subtract_vav(PS_SONAR, PS_GLOBAL_POS);*/
                
                /*NodeVec2Array
                PS_OBS_GLOBAL = new va_Add_vav(PS_OBS, PS_GLOBAL_POS);*/
		...
		MS_AVOID_OBSTACLES = new v_AvoidSonar_va(3.0, abstract_robot.RADIUS + 0.1,
			PS_ALL_OBS, PS_GLOBAL_POS);
                ...
                /*NodeVec2
		MS_AVOID_OBSTACLES = new v_Avoid_va(3.0, abstract_robot.RADIUS + 0.1,
			PS_OBS);*/
		...
		//======
                ...
                SONAR_CONFIGURATION.sonarActived[0] = new int[]{};
                SONAR_CONFIGURATION.sonarPrecision[0] = SonarObjectSensor.HIGH;
                SONAR_CONFIGURATION.sonarActived[1] = new int[]{};
                SONAR_CONFIGURATION.sonarPrecision[1] = SonarObjectSensor.HIGH;
                SONAR_CONFIGURATION.sonarActived[2] = new int[]{};
		...
		sonar_strategy = new DynamicSonarStrategy();	//Inizializzo la strategia
