...
public class SharedMemory {
    ...
    public void push(Vec2 im1, int visual)
    {
    ...
    public void visualizzaBandiereColore(){
        for(int i=0; i<last_val.length; i++)
        {
    ...
    public Vec2[] value(long timestamp,Vec2 position,Vec2[] im0_1, Vec2[] im0_2,Vec2[] im0_3) {
   ...
   /* public void push(Vec2 im1, int visual, long timestamp)
    {
        boolean canPush=true;
        if (containFlag(im1)==false)
            {
                listaBandiere.add(im1);
                //salva il colore della bandiera tramite la mappa [k,v] dove k è l'oggetto di tipo Vec2 della posizione della bandiera
