...
public class RoomLocation {
		...
		private static boolean closedAntiRoomRed;
		private static boolean closedAntiRoomGreen;
		private static boolean closedAntiRoomBlue; 

		private static boolean closedAllAntiRoom = closedAntiRoomBlue && closedAntiRoomGreen && closedAntiRoomRed;
...
public static void chiudiAnticamera(String anticamera)
{
	if(anticamera.equals("rossa"))
	{
		closedAntiRoomRed=true;
	}
	else if(anticamera.equals("verde"))
	{
		closedAntiRoomGreen=true;
	}
	else if(anticamera.equals("blue"))
	{
		closedAntiRoomBlue=true;
	}
	else
	{
...
public static boolean getClosedAntiRoomRed()
{
	return closedAntiRoomRed;
}

public static boolean getClosedAntiRoomGreen()
{
	return closedAntiRoomGreen;
}

public static boolean getClosedAntiRoomBlue()
{
	return closedAntiRoomBlue;
}

public static boolean getClosedAllAntiRoom()
{
	return closedAllAntiRoom;
}
