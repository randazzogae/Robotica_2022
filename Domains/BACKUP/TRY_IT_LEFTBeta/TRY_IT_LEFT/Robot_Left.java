...
*/
    ...
    if(state==2){
        ...
        if(state==4){
			if(!roomLocation.getClosedAllAntiRoom())
			{
				begin1=true;
   			tempo=0;
        	stall=0;
    		...
    		if((!red_room_Left&&roomLocation.closed_red_Left())&&!roomLocation.getClosedAntiRoomRed()||(!green_room_Left&&roomLocation.closed_green_Left()&&!roomLocation.getClosedAntiRoomGreen())||(!blue_room_Left&&roomLocation.closed_blue_Left()&&!roomLocation.getClosedAntiRoomBlue())||(!lab_room&&roomLocation.closed_lab_()) ||(!red_room_Right&&roomLocation.closed_red_Right())||(!green_room_Right&&roomLocation.closed_green_Right())||(!blue_room_Right&&roomLocation.closed_blue_Right()))
    		{
