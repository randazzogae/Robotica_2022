...
*/
    ...
    if(state==2){
        ...
        if(state==4){
    		...
    		if((!red_room_Left&&roomLocation.closed_red_Left())&&!roomLocation.getIsClosedAntiRoomRed()||(!green_room_Left&&roomLocation.closed_green_Left()&&!roomLocation.getIsClosedAntiRoomGreen())||(!blue_room_Left&&roomLocation.closed_blue_Left()&&!roomLocation.getIsClosedAntiRoomBlue())||(!lab_room&&roomLocation.closed_lab_()) ||(!red_room_Right&&roomLocation.closed_red_Right())||(!green_room_Right&&roomLocation.closed_green_Right())||(!blue_room_Right&&roomLocation.closed_blue_Right()))
    		{
        	...
        	//if(roomLocation.in_room()){
				if(roomLocation.in_blue_Left())
				{
					abstract_robot.setDisplayString("Explore anticamera blue");
        		swirlgain.setValue(0.5);
            	avoidgain.setValue(0.0);
    			noisegain.setValue(0.0);
				roomLocation.chiudiAnticamera("blue");
				}
				else if(roomLocation.in_red_Left())
				{
					abstract_robot.setDisplayString("Explore anticamera rossa");
        		swirlgain.setValue(0.5);
            	avoidgain.setValue(0.0);
    			noisegain.setValue(0.0);
				roomLocation.chiudiAnticamera("rossa");
				}
				else if(roomLocation.in_green_Left())
				{
					abstract_robot.setDisplayString("Explore anticamera verde");
        		swirlgain.setValue(0.5);
            	avoidgain.setValue(0.0);
    			noisegain.setValue(0.0);
				roomLocation.chiudiAnticamera("verde");
				}
