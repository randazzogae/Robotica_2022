...
public class RoomLocation {
		...
		private boolean isClosedAntiRoomRed;
		private boolean isClosedAntiRoomGreen;
		private boolean isClosedAntiRoomBlue; 

		private boolean areClosedAllAntiRooms = isClosedAntiRoomBlue && isClosedAntiRoomGreen && isClosedAntiRoomRed;
...
public void chiudiAnticamera(String anticamera)
{
	...
	{
		isClosedAntiRoomRed=true;
	}
	else if(anticamera.equals("verde"))
	{
		isClosedAntiRoomGreen=true;
	}
	else if(anticamera.equals("blue"))
	{
		isClosedAntiRoomBlue=true;
	}
	else
	{
...
public boolean getIsClosedAntiRoomRed()
{
	return isClosedAntiRoomRed;
}

public boolean getIsClosedAntiRoomGreen()
{
	return isClosedAntiRoomGreen;
}

public boolean getIsClosedAntiRoomBlue()
{
	return isClosedAntiRoomBlue;
}
