            ...
            //abstract_robot.setDisplayString("Attack");
				...
				if(action.startsWith("goto(")){
						if(attack_plan.getParameter()[0].equals("prima_cella")){
								if(id==0)
								{
									PS_ATTRACTOR.setValue(curr_time,29.0,27.2); //vai alla cella 7
								}
								else
								{
									PS_ATTRACTOR.setValue(curr_time,26.0,17.0);
						...
						if(attack_plan.getParameter()[0].equals("seconda_cella")){
								...
								{
									PS_ATTRACTOR.setValue(curr_time,25.0,15.0);
								}
						...
						if(attack_plan.getParameter()[0].equals("terza_cella")){
								...
								{
									PS_ATTRACTOR.setValue(curr_time,24.0,14.0);
								}
						...
						if(attack_plan.getParameter()[0].equals("quarta_cella")){
							if(id==0)
								{
									PS_ATTRACTOR.setValue(curr_time,18.0,27.0); //vai alla cella 4
								}
								else
								{
						...
						if(attack_plan.getParameter()[0].equals("quinta_cella")){
							if(id==0)
								...
								{
									PS_ATTRACTOR.setValue(curr_time,21.0,12.0);
								}
