...
*/
    ...
    if(state==2){
        ...
        if(state==4){
    		...
    		if((!red_room_Left&&roomLocation.closed_red_Left())||(!green_room_Left&&roomLocation.closed_green_Left())||(!blue_room_Left&&roomLocation.closed_blue_Left())||(!lab_room&&roomLocation.closed_lab_()) ||(!red_room_Right&&roomLocation.closed_red_Right())||(!green_room_Right&&roomLocation.closed_green_Right())||(!blue_room_Right&&roomLocation.closed_blue_Right()))
    		{
