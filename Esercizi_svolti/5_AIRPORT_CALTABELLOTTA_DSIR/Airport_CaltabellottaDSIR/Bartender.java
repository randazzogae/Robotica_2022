...
public class Bartender extends ControlSystemMFN150 {
    ...
    public void configure() {
        ...
        abstract_robot.setBaseSpeed(0*abstract_robot.MAX_TRANSLATION);
    ...
    public int takeStep() {
        ...
        if(state==0)
            abstract_robot.setDisplayString("Bartender");
